...
public class UserData {
    ...
    /**
     * ItemGet a value by name, or add one from the provided supplier if absent
     *
     * @param name the name of the value to get
    ...
    /**
     * ItemGet a value by name, or return a default value if absent
     *
    ...
    /**
     * Check if a value is present and equal to the provided object
     *
     * @param name the name of the value to check
     * @param object the Object to check against for equality
     * @return true if the value is present and equal to the given Object
     */
    public boolean presentAndEquals(String name, Object object) {
